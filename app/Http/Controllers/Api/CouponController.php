...
class CouponController extends Controller
{
    ...
    public function validCouponForCourse($coupon, $auth)
    {
        ...
        if (isset($cart)) {
            if ($cart->course_id == $coupon->course_id &&  $cart->coupon_id != $coupon['id']) {
    ...
    public function validCouponForBundle($coupon)
    {
        ...
        if (isset($cart)) {
            if ($cart->bundle_id == $coupon->bundle_id && $cart->coupon_id != $coupon->id) {
    ...
    public function remove(Request $request)
    {
        ...
        Cart::where('user_id', '=', $user->id)
            ->update(['distype' => NULL, 'disamount' => NULL, 'coupon_id' => NULL]);
    ...
    public function removeById(Request $request)
    {
        ...
        Cart::where('user_id', '=', $user->id)->where('coupon_id', '=', $request->coupon_id)
            ->update(['distype' => NULL, 'disamount' => NULL, 'coupon_id' => NULL]);
