...
@section('maincontent')
				...
				<div class="widgetbar">
					@can('course-languages.delete')
						<a href="page-product-detail.html" class="btn btn-danger-rgba" data-toggle="modal" data-target=".bd-example-modal-sm1"><i
								class="feather icon-trash mr-2"></i>Delete Selected</a>
					@endcan
					...
					@can('course-languages.create')
						<a data-toggle="modal" data-target="#myModaljjh" href="#" class="btn btn-primary-rgba mr-2"><i
								...
								<tbody>
									...
									@foreach ($language as $cat)
										...
										<tr>
											...
											<td>{{ $cat->getTranslation('name', app()->getlocale())}}</td>
											<td>
												<label class="switch">
													<input class="courselanguage" type="checkbox" data-id="{{ $cat->id }}" name="status"
											...
											<td>
												@if (Auth::user()->role == 'admin')
													...
													<div class="modal fade bd-example-modal-sm" id="edit{{ $cat->id }}" tabindex="-1" role="dialog"
														aria-hidden="true">
                                              ...
                                              "data-parsley-validate
																		...
																		<div class="col-md-12">
																			<div class="form-group">
																				<label for="exampleInputSlug">{{ __('adminstaticword.English Title') }}: <sup
																						class="redstar">*</sup></label>
																				<input type="text" class="form-control" name="name_en" value="{{ $cat->getTranslation('name', 'en', false)}}"
																					id="exampleInputPassword1"
																					placeholder="{{ __('adminstaticword.Please') }}  {{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Language') }}">
																			</div>

																			<div class="form-group">
																				<label for="exampleInputSlug">{{ __('adminstaticword.Arabic Title') }}: <sup
																						class="redstar">*</sup></label>
																				<input type="text" class="form-control" name="name_ar" value="{{ $cat->getTranslation('name', 'ar', false)}}"
																					id="exampleInputPassword1"
																					placeholder="{{ __('adminstaticword.Please') }}  {{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Language') }}">
																			</div>
	...
	!--Model for add Language -->
	<div class="modal fade" id="myModaljjh" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="demo-form2" method="post" action="{{ route('courselang.store') }}" data-parsley-validate
						class="form-horizontal form-label-left">
						{{ csrf_field() }}
						...
						<div class="row">
							<div class="col-md-12">
								<label for="exampleInputSlug">{{ __('adminstaticword.English Title') }}:<sup class="redstar">*</sup></label>
								<input type="text" class="form-control" name="name_en" id="exampleInputPassword1"
									placeholder="{{ __('adminstaticword.Please') }} {{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Language') }}"
									value="">
							</div>
							<br>
							...
							<div class="col-md-12">
								<label for="exampleInputSlug">{{ __('adminstaticword.Arabic Title') }}:<sup class="redstar">*</sup></label>
