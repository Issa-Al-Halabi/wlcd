    ...
    <form action="{{ route('course.update', $cor->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="title" id="exampleInputTitle"
                    value="{{ $cor->getTranslation('title', 'ar') }}">
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <textarea name="short_detail" rows="3" class="form-control">{!! $cor->getTranslation('short_detail', 'ar') !!}</textarea>
            </div>
            <div class="col-md-6">
                <label for="exampleInputDetails">{{ __('Requirements') }}:<sup class="redstar">*</sup></label>
                <textarea name="requirement" rows="3" class="form-control" required>{!! $cor->getTranslation('requirement', 'ar') !!}</textarea>
            </div>
        </div>
        <br>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="form-control js-example-basic-single" name="level_tags">
                        ...
                        <option {{ $cor->getTranslation('level_tags', 'ar') == 'مبتدئ' ? 'selected' : '' }}
                            value="مبتدئ">
                            {{ __('مبتدئ') }}</option>

                        <option {{ $cor->getTranslation('level_tags', 'ar') == 'متوسط' ? 'selected' : '' }}
                            value="متوسط">
                            {{ __('متوسط') }}</option>

                        <option {{ $cor->getTranslation('level_tags', 'ar') == 'خبير' ? 'selected' : '' }}
                            value="خبير">
                            {{ __('خبير') }}</option>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <textarea id="detail" name="detail" rows="3" class="form-control">{!! $cor->getTranslation('detail', 'ar') !!}</textarea>
            </div>
        </div>
        <br>
