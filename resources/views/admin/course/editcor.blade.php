                ...
                <form action="{{ route('course.update', $cor->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="childcategory_id" id="grand" class="form-control js-example-basic-single">
                                @php
                                    $childcategory = App\ChildCategory::where(
                                        'subcategory_id',
                                        $cor->subcategory_id,
                                    )->get();
                                @endphp
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select multiple="multiple" name="other_cats[]" id="other_cats"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            @endphp
                            <label for="exampleInputSlug">{{ __('SelectLanguage') }}: <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="exampleInputDetails">{{ __('Requirements') }}:<sup
                                    class="redstar">*</sup></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('start_date') }}" type="text" id="start-date1"
              ...
              <input type="number" min="1" class="form-control" name="day" id="exampleInputPassword1" placeholder="{{ __('Enter') }} day" value="{{ $cor->day }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <div style="{{ $cor->type == 1 ? '' : 'display:none' }}" id="doabox">
                                ...
                                <input step="0.01" type="text" inputmode="numeric"
                                    ...
                                    id="priceMain" placeholder="{{ __('Enter') }} {{ __('Price') }}"
                                    value="{{ $cor->price }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div style="{{ $cor->preview_type == 'url' ? 'display:none' : '' }}" id="document1">
                                <br>
                                <label for="exampleInputSlug">{{ __('UploadVideo') }}: <sup
                                        class="redstar">*</sup></label>
                                <!-- -------------- -->
                            ...
                            <div @if ($cor->preview_type == 'video') class="display-none" @endif id="document2">
                                <br>
                                <label for="exampleInputSlug">{{ __('URL') }}: <sup
                                        class="redstar">*</sup></label>
