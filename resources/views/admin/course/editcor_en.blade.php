                  ...
                  <div style="{{ $cor->day == 1 ? '' : 'display:none' }}" id="jeet">
                    ...
                    <div class="row">
                        ...
                        @if (Auth::user()->role == 'instructor')
                            ...
                            <div class="col-md-6">
                                <label>{{ __('adminstaticword.PreviewImage') }} 2:size: 200x200</label>
                                <br>
                                <!-- ====================== -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <div class="custom-file">
                                        <input type="text" class="custom-file-input" id="thumble_preview_image"
                                            name="thumble_preview_image" value="{{ $cor->thumble_preview_image }}">
                                        <label class="custom-file-label"
                                            for="inputGroupFile01">{{ __('Choose file') }}</label>
                                    </div>
                                </div>
                                @if ($cor['thumble_preview_image'] !== null && $cor['thumble_preview_image'] !== '')
                                    <img src="{{ url('/images/course/' . $cor->thumble_preview_image) }}" height="70px;"
                                        width="70px;" />
                                @else
                                    <img src="{{ Avatar::create($cor->title)->toBase64() }}" alt="course"
                                        class="img-fluid">
                        ...
                        @if (Auth::user()->role == 'admin')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="first-name">{{ __('Image') }} 2 <span
                                            class="required">*</span> </label>

                                    <div class="input-group">

                                        <input required readonly id="thumble_preview_image" name="thumble_preview_image" type="text"
                                            class="form-control"
                                            value="{{ $cor['thumble_preview_image'] != null ? $cor['thumble_preview_image'] : '' }}">
                                        <div class="input-group-append">
                                    ...
                                    <small class="text-info"> <i
                                            class="text-dark feather icon-help-circle"></i>({{ __('Choose Thumble Image for
                                                                                                                  post') }})</small>
                                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                              ...
                              <select name="course_type" class="form-control">
                                  <option value="1" {{$cor['course_type']  == 1 ? 'selected' : ''}}>Online</option>
                                  <option value="2" {{$cor['course_type']  == 2 ? 'selected' : ''}}>Record</option>
                              </select>
