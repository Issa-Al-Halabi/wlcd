	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card m-b-30">
				...
				<div class="card-body">
					<form id="en_create" action="{{ action('BlogController@store') }}" class="form" method="POST" novalidate
												...
												<div class="row">
													...
													@if (Auth::user()->role == 'admin')
														<div class="form-group col-md-3">
															<label class="text-dark" for="exampleInputDetails">{{ __('adminstaticword.Approved') }}
...
<script>
	DecoupledEditor
		...
		.then(editor => {
			...
			const form = document.querySelector('#en_create');
