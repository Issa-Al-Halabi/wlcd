				...
				<form action="{{ action('AboutController@update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<textarea required name="about_description" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('about_description', 'ar', false) }}</textarea>
							<br>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-6">
									<label class="text-dark" for="one_heading">{{ __('Section 1 Heading :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="one_heading" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('one_heading', 'ar', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-6">
									<label class="text-dark" for="one_text">{{ __('Section 1 Text :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="one_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('one_text', 'ar', false) }}</textarea>
									<br>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<label class="text-dark" for="two_heading">{{ __('Section 2 Heading :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_heading" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_heading', 'ar', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-6">
									<label class="text-dark" for="two_text">{{ __('Section 2 Text :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_text', 'ar', false) }}</textarea>
									<br>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">
									<label class="text-dark" for="two_first_title">{{ __('Section 2 first title:') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_first_title" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_first_title', 'ar', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="two_second_title">{{ __('Section 2 secont title :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_second_title" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_second_title', 'ar', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="two_third_title">{{ __('Section 2 third title :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_third_title" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_third_title', 'ar', false) }}</textarea>
									<br>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-4">
									<label class="text-dark" for="two_first_text">{{ __('Section 2 first text:') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_first_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_first_text', 'ar', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="two_second_text">{{ __('Section 2 secont text :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_second_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_second_text', 'ar', false) }}</textarea>
									<br>
								</div>
								...
								<div class="col-md-4">
									<label class="text-dark" for="two_third_text">{{ __('Section 2 third text :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="two_third_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('two_third_text', 'ar', false) }}</textarea>
									<br>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<label class="text-dark" for="three_first_heading">{{ __('Section 3 first Heading :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="three_first_heading" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('three_first_heading', 'ar', false) }}</textarea>

								</div>
								<div class="col-md-6">
									<label class="text-dark" for="three_second_heading">{{ __('Section 3 second Heading :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="three_second_heading" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('three_second_heading', 'ar', false) }}</textarea>
									<br>
								</div>
							</div>
							<br>
							<div class="row">
								<div class="col-md-6">
									...
									<label class="text-dark" for="three_first_text">{{ __('Section 3 first text :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="three_first_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('three_first_text', 'ar', false) }}</textarea>
								</div>

								<div class="col-md-6">
									<label class="text-dark" for="three_second_text">{{ __('Section 3 second text :') }} <span
											class="text-danger">*</span></label>
									<textarea required name="three_second_text" rows="3" class="form-control" placeholder="Enter Your Text">{{ $data->getTranslation('three_second_text', 'ar', false) }}</textarea>
								</div>
							</div>
							<br>
							<div class="row">
							...
							{{-- <div class="row">
								<div class="col-md-6">
									<label class="text-dark" for="three_third_text">{{ __('Section 3 third text :') }} <span
											class="text-danger">*</span></label>
									<input required value="{{ $data->getTranslation('three_third_text', 'ar', false) }}" name="three_third_text"
								...
								<div class="col-md-6">
									<label class="text-dark" for="three_fourth_text">{{ __('Section 3 fourth text :') }} <span
											class="text-danger">*</span></label>
									<input required value="{{ $data->getTranslation('three_fourth_text', 'ar', false) }}"
