							...
							<div class="row">
								<div class="form-group col-md-6">
									<div id="update-password">
										...
										<select required name="course_id" id="course_id" class="select2-single form-control">
								...
								<div class="form-group col-md-6">
									...
									<div class="input-group mb-3">
										...
										<div class="custom-file">
											<input type="file" type="file" name="image" id="image" class="custom-file-input"
								...
								<input hidden id="myCheck" name="link_by" class="custom_toggle" value="1" onclick="myFunction()">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="topic" placeholder="{{ __('Example: My Meeting') }}" class="form-control"
										required>
								</div>
