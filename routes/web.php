    ...
    */
    ...
    Route::middleware(['web'])->group(function () {
        ...
        Route::middleware(['IsInstalled', 'switch_languages', 'ip_block'])->group(function () {
            ...
            Route::get('email/verify/{id}/{hash}', 'Auth\VerificationController@verify')->name('web.verification.verify');
            ...
            Route::middleware(['admin_instructor', 'IsInstalled', 'auth'])->group(function () {
                ...
                Route::get('/category/{slug}', 'CategoriesController@show')->name('web.category.show');
                ...
                Route::get('/course/create/{id}', 'CourseController@showCourse')->name('web.course.show');
                ...
                Route::resource('languages', 'LanguageController')->names([
                    ...
                    'create' => 'languages.createe',
                    'store' => 'languages.storee',
                    'update' => 'languages.updatee',
                    'destroy' => 'languages.deletee',
                ]);;
                ...
                Route::get('/quickupdate/slider', 'QuickUpdateController@sliderQuick')->name('web.slider.quick');
                ...
                Route::delete('faqinstructor-deleteAll', 'FaqInstructorController@deleteAll')->name('web.faqinstructor.bulk.delete');
                ...
                Route::post('batch/deleteall', 'BatchController@batchdeleteAll')->name('web.batch.bulk_delete');
        ...
        Route::middleware(['is_verified', '2fa', 'maintanance_mode', 'switch_languages'])->group(function () {
            ...
            if (env('DEFAULT_THEME') == 'classic') {
                ...
                Route::get('pages/{slug}', 'PageController@showpage')->name('web.page.show');
